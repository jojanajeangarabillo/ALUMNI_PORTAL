...
if (isset($_POST['action'])) {
    ...
    if ($action == 'add') {
        ...
        $sql = "INSERT INTO events (title, content, schedule, banner) 
                VALUES ('$title', '$content', '$schedule', $banner_sql)";
        ...
        if($banner_img) {
            ...
            $sql = "UPDATE events SET title='$title', content='$content', 
                    schedule='$schedule', banner='$banner_img' WHERE id=$event_id";
        } else {
            $sql = "UPDATE events SET title='$title', content='$content', 
                    schedule='$schedule' WHERE id=$event_id";
        }
      ...
      <div class="event-modal-content">
          ...
          <form id="editEventForm" method="POST" action="admin-event.php" enctype="multipart/form-data">
              ...
              <div class="banner-preview">
                  <img id="currentBanner" src="" alt="Current Banner">
              </div>
              <input type="file" id="editBanner" name="banner" class="file-input" accept="image/*">
  ...
  <div class="event-modal" id="addEventModal">
      <div class="event-modal-content">
          ...
          <form id="addEventForm" method="POST" action="admin-event.php" enctype="multipart/form-data">
              ...
              <input type="file" id="addBanner" name="banner" class="file-input" accept="image/*">
              <div class="banner-preview">
                  <img id="newBannerPreview" src="images/no-image-available.png" alt="Banner Preview">
              </div>
