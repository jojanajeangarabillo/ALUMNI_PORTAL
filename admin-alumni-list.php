...
<body>
    ...
    <div id="al-content">
        ...
        <div class="al-main-content">
            <header>List of Alumnis</header>
            <hr>
            <div class="alist-search">
                <form>
                    <label class="alist-label">Search: </label>
                    <input type="text">
                    <button type="button" class="alist-filter">Filter</button>
                </form>
            </div>
            ...
            <div class="table-alist">
                <table>
                    ...
                    <tr>
                        ...
                        <td><button type="button" class="btn-save">Save</button></td>
                        <td>
                            <button type="button" class="btn-save">Save</button>
                            <a href="manage-profile.php" class="btn-edit">Edit</a>
